...
//buttons
Button startButton = new Button(400, 475, 150, 50, "Start!", Screen.SIMULATOR);
...
void toWelcomeScreen() {
  ...
  textSize(32);
  fill(0);
  text("Welcome to Physics CollisionSim!", 225, 200);
  textSize(16);
  ...
  " Press the start button to begin. Have Fun!", 200, 275, 600, 200);
